...
class User(db.Model):
    ...
    coach_gender = db.Column(db.String(16), nullable=True)
    coach_personality = db.Column(db.String(32), nullable=True)
    join_date = db.Column(db.DateTime, default=_utcnow)
